...
describe("Header", () => {
  test("Empty", () => {
    const { asFragment } = render(
      <StateProvider state={baseState}><Header /></StateProvider>
    );
  ...
  test("Only Title", () => {
    ...
    expect(getByText(/Contentz/))
      .toHaveAttribute("title", baseState.i18n.header.mainLinkDescription);
  ...
  test("Complete", () => {
    ...
    expect(getByText(/Books/))
      .toHaveAttribute("href", "https://leanpub.com/u/sergiodxa/");
